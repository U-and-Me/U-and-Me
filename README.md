...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="z-index:1;position:relative" width="854" height="200" viewBox="0 0 854 300">
  <style>
    .text {
      font-size: 90px;
      font-weight: 700;
  ...
  <text text-anchor="middle" alignment-baseline="middle" x="50%" y="50%" class="text" style="fill:#032539;">Kim Yu Na</text>
</svg>
